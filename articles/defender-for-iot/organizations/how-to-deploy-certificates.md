---
title: Set up SSL/TLS appliance certificates
description: Learn how to set up and deploy certificates for Defender for IoT.
ms.date: 02/06/2022
ms.topic: how-to
---

# Certificates for appliance encryption and authentication on OT monitoring appliances

This article provides information needed when creating and deploying certificates for Microsoft Defender for IoT OT network sensors and on-premises management consoles. A security, PKI or other qualified certificate lead should handle certificate creation and deployment.
